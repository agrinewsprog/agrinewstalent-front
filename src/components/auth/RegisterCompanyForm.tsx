...
export default function RegisterCompanyForm({ onSuccess }: RegisterCompanyFormProps) {
  ...
  const [formData, setFormData] = useState<Partial<CompanyFormData>>({
    email: '', password: '', telefono: '', razonSocial: '',
    cif: '', pais: '', direccion: '', codigoPostal: '',
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (onSuccess) {
        ...
        router.push(`/${locale}/intranet/company/dashboard`);
      }
    } catch (error: any) {
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`block w-full pl-10 pr-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${errors.telefono ? 'border-red-500' : 'border-gray-300'}`}
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            type="text" id="razonSocial" name="razonSocial" value={formData.razonSocial} onChange={handleChange}
            className={`block w-full pl-10 pr-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${errors.razonSocial ? 'border-red-500' : 'border-gray-300'}`}
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            type="text" id="cif" name="cif" value={formData.cif} onChange={handleChange}
            className={`block w-full pl-10 pr-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${errors.cif ? 'border-red-500' : 'border-gray-300'}`}
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            type="text" id="direccion" name="direccion" value={formData.direccion} onChange={handleChange}
            className={`block w-full pl-10 pr-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${errors.direccion ? 'border-red-500' : 'border-gray-300'}`}
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            type="text" id="codigoPostal" name="codigoPostal" value={formData.codigoPostal} onChange={handleChange}
            className={`block w-full pl-10 pr-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${errors.codigoPostal ? 'border-red-500' : 'border-gray-300'}`}
