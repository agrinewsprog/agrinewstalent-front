...
export function StudentLayoutClient({ user, children }: StudentLayoutClientProps) {
  ...
  const studentNavigation = [
    {
      name: t('dashboard'),
      href: `/${locale}/intranet/student/dashboard`,
      icon: (
    ...
    {
      name: t('saved'),
      href: `/${locale}/intranet/student/saved-offers`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: t('programs'),
      href: `/${locale}/intranet/student/programs`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      href: `/${locale}/intranet/student/notifications`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
