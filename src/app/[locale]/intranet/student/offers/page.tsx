...
import { Offer, CourseEnrollment } from '@/types';
...
import { resolveJobOfferId, unwrapCollection } from '@/lib/frontend/contracts';
...
async function getAppliedOfferIds(): Promise<string[]> {
  try {
    ...
    return apps
      .map((application) => resolveJobOfferId(application, (application as { offer?: unknown }).offer))
        ...
        <Card>
          <CardBody>
            <div className="text-center py-12">
              ...
              <Link
                href={buildLocaleHref(locale, '/intranet/student/courses')}
