  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        try {
          ...
          const hint =
            meErr instanceof ApiClientError && meErr.status === 401
              ? 'Session not established. Check your cookie/CORS settings.'
              : 'Login OK but session could not be verified. Please try again.';
      ...
      const dashboardByRole: Record<string, string> = {
        COMPANY:     `/${locale}/intranet/company/dashboard`,
        STUDENT:     `/${locale}/intranet/student/dashboard`,
        UNIVERSITY:  `/${locale}/intranet/university/dashboard`,
        SUPER_ADMIN: `/${locale}/intranet/admin/dashboard`,
        company:     `/${locale}/intranet/company/dashboard`,
        student:     `/${locale}/intranet/student/dashboard`,
        university:  `/${locale}/intranet/university/dashboard`,
        super_admin: `/${locale}/intranet/admin/dashboard`,
        admin:       `/${locale}/intranet/admin/dashboard`,
        ADMIN:       `/${locale}/intranet/admin/dashboard`,
      };
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        <div className="bg-white rounded-2xl shadow-xl px-8 pt-7 pb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <p className="text-center text-sm font-semibold text-gray-700 mb-1">{t('fillData')}</p>
          ...
          <p className="mt-5 text-center text-xs text-gray-500">
            {t('noAccount')}{' '}
            <a href={`/${locale}/registro`} className="text-green-600 hover:text-green-700 font-semibold">
              {t('registerLink')}
            </a>
          </p>
        </div>
