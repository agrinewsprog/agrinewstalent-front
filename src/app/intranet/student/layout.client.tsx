...
const studentNavigation = [
  {
    name: 'Dashboard',
    href: '/intranet/student/dashboard',
    icon: (
  ...
  {
    name: 'Guardadas',
    href: '/intranet/student/saved-offers',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  {
    name: 'Notificaciones',
    href: '/intranet/student/notifications',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
...
export function StudentLayoutClient({ user, children }: StudentLayoutClientProps) {
  return (
    <div className="flex min-h-screen bg-gray-50">
      <Sidebar user={user} navigation={studentNavigation} />
