...
const statusLabel: Record<string, { text: string; color: string }> = {
  SUBMITTED:           { text: 'Enviada',    color: 'bg-gray-100 text-gray-600' },
  VIEWED:              { text: 'Vista',      color: 'bg-blue-100 text-blue-700' },
  INTERVIEW_REQUESTED: { text: 'Entrevista', color: 'bg-purple-100 text-purple-700' },
  HIRED:               { text: 'Contratado', color: 'bg-green-100 text-green-700' },
  REJECTED:            { text: 'Rechazada',  color: 'bg-red-100 text-red-600' },
};
  ...
  return (
    <div className="space-y-7">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: 'Candidaturas', value: totalApplications, icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', color: 'text-blue-600 bg-blue-50' },
          { label: 'Entrevistas', value: interviews, icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', color: 'text-purple-600 bg-purple-50' },
          { label: 'Ofertas activas', value: offersCount, icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', color: 'text-green-600 bg-green-50' },
          { label: 'Guardadas', value: savedCount, icon: 'M5 4a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 20V4z', color: 'text-amber-600 bg-amber-50' },
        ].map(stat => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {featuredOffers.length > 0 && (
            <section>
              <div className="flex items-center justify-between mb-3">
                ...
                <Link href="/intranet/student/offers" className="text-xs text-green-600 hover:text-green-700 font-medium">Ver todas </Link>
              </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-3">
              <h2 className="font-semibold text-gray-800">Últimas ofertas</h2>
              <Link href="/intranet/student/offers" className="text-xs text-green-600 hover:text-green-700 font-medium">Ver todas </Link>
            </div>
            {recentOffers.length === 0 ? (
              <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center">
                <p className="text-gray-400 text-sm">No hay ofertas disponibles ahora mismo</p>
              </div>
            ) : (
              <div className="space-y-2">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Mis candidaturas recientes */}
          <section>
            <div className="flex items-center justify-between mb-3">
              <h2 className="font-semibold text-gray-800">Mis candidaturas</h2>
              <Link href="/intranet/student/applications" className="text-xs text-green-600 hover:text-green-700 font-medium">Ver todas </Link>
            </div>
            ...
            {applications.length === 0 ? (
              <div className="bg-white rounded-2xl border border-gray-100 p-6 text-center">
                ...
                <p className="text-gray-400 text-sm">Aún no has aplicado a ninguna oferta</p>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                {applications.slice(0, 5).map((app: any, i: number) => {
                  const st = statusLabel[app.status] ?? { text: app.status, color: 'bg-gray-100 text-gray-600' };
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                { href: '/intranet/student/profile', label: 'Mi perfil', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', color: 'bg-blue-50 text-blue-700 hover:bg-blue-100' },
                { href: '/intranet/student/saved-offers', label: 'Guardadas', icon: 'M5 4a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 20V4z', color: 'bg-amber-50 text-amber-700 hover:bg-amber-100' },
                { href: '/intranet/student/applications', label: 'Candidaturas', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', color: 'bg-purple-50 text-purple-700 hover:bg-purple-100' },
                { href: '/intranet/student/offers', label: 'Explorar', icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z', color: 'bg-green-50 text-green-700 hover:bg-green-100' },
              ].map(item => (
                <Link
                  key={item.href}
                  href={item.href}
