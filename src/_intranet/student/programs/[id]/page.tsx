...
export default async function StudentProgramDetailPage({
  ...
  const statusLabels: Record<string, string> = {
    draft: t('student.programs.statusLabels.draft'),
    active: t('student.programs.statusLabels.active'),
    closed: t('student.programs.statusLabels.closed'),
  };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        >
          {t('student.programs.backToPrograms')}
        </Link>
      </div>
        ...
        <Card>
          <CardBody>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mt-1">{t('student.programs.availableOffers')}</p>
            </div>
          </CardBody>
        </Card>
        <Card>
          <CardBody>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mt-1">{t('student.programs.participatingCompanies')}</p>
            </div>
          </CardBody>
        </Card>
      </div>
